...
namespace Core
{
    ...
    public:
        ...
        cEuler( T axis0, T axis1, T axis2, int rotationOrder )
            : mAxis0( axis0 ), mAxis1( axis1 ), mAxis2( axis2 ), mRotationOrder( rotationOrder )
        {
        }
    ...
    typedef cEuler<float>  CORE_API cEulerf;
    typedef cEuler<double> CORE_API cEulerd;
}
