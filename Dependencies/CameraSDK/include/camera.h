...
namespace CameraLibrary
{
    ...
    public:
        ...
        void        SetLateDecompression(bool Enable);      //== Only decode scene data that =---
        bool        LateDecompression();                    //== that you actually use =======---

        int         Serial() const;						    //== Device serial number ========---
        const char* SerialString() const;                   //== Device serial number ========---
        int         Model() const;						    //== Device model number =========---
        int         SubModel() const;					    //== Device sub model number =====---
        int         Revision() const;						//== Device revision number ======---
        int         HardwareInterface() const;              //== Device hardware interface ===---
        ...
        virtual bool IsWindowingSupported();  //== Imager windowing capability ----
        ...
        virtual bool IsBaseStation()  { return false; }  //== Camera helpers =================---
        ...
        virtual void SetGrayscaleFloor( int intensity ); //== Set background intensity level =---
                                                         //== to be considered as black      =---
                                                         //== Precision Mode only. 
        ...
        virtual int  MaximumFullImageFrameRateValue();//== Returns the maximum full image frame rate ====---
        ...
        virtual bool IsColor();                       //== Is color camera? =================----
        ...
        virtual float           ColorGamma();
        virtual sColorPrescalar ColorPrescalar();   
        virtual int             ColorMode();
        virtual float           ColorCompression();
        virtual float           ColorBitRate();
        ...
        virtual void         SetPixelIntensityMapping( int floor, int count, float *map );
    ...
    public:
        ...
        //== internal use ==--
        virtual void HardwareTimeResponse( const sHardwareTimeInfo & timeInfo );
    };
}
