...
namespace CameraLibrary
{
    ...
    public:
        ...
        virtual bool PostMJPEGData( Camera *Camera, unsigned char *Buffer, long BufferSize, Frame *Frame, int FrameWidth, int FrameHeight );
        virtual bool PostVideoData( Camera *Camera, unsigned char *Buffer, long BufferSize, Frame *Frame, int FrameWidth, int FrameHeight,
