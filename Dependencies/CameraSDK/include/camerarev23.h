...
namespace CameraLibrary
{
	...
	const unsigned int kESYNC2_INPUT_COUNT     = 9;  //== 8 real + 1 virtual
    ...
    {                                        //== Engineer's Comments ===----
        ...
        unsigned char OutputClockStatus() const
        {
            // bits 16..19 indicate the internal clock output status on output ports 1-4
            return (unsigned char) (Status >> 16 & 0xF);
        }
