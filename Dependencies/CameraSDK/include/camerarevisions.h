...
namespace
{
    ...
    const int    PRIMEX_41_REVISION     = 49;
    const int    PRIMEX_13_REVISION     = 51;
    const int    PRIMEX_13W_REVISION    = 52;
    const int    SLIMX_13E_REVISION     = 53;
    const int    PRIMEX_41W_REVISION    = 54;

    const int    PRIMEX_22_REVISION     = 50;
